// Firebase project config — safe to keep public in client code;
// access is controlled by Firebase Authentication/Security Rules, not by hiding this.
export const firebaseConfig = {
  apiKey: "AIzaSyCFmvMT7kRL4wrYa6RmEa3X0j0w3Su7SgI",
